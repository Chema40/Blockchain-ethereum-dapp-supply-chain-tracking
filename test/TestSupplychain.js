...
let emptyAddress = '0x00000000000000000000000000000000000000';
    ...
    let originFarmName = "John Doe";
    let originFarmInformation = "Yarray Valley";
    let originFarmLatitude = "-38.239770";
    let originFarmLongitude = "144.341490";
    let productID = sku + upc;
    let productNotes = "Best beans for Espresso";
    let productPrice = web3.toWei(1, "ether");
    let itemState = 0;
    let distributorID = emptyAddress;
    let retailerID = emptyAddress;
    let consumerID = emptyAddress;
    emptyAddress = '0x00000000000000000000000000000000000000';
...
contract('SupplyChain', function(acc) {
    ...
    let originFarmerID = accounts[1];
    let distributorID = accounts[2]
    let retailerID = accounts[3]
    let consumerID = accounts[4]
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        //Give originFarmerId the farmer role
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferTwo[5].toNumber(), 7,'Invalid itemState');
        assert.equal(resultBufferTwo[6], distributorID,'Invalid distributorID');
        assert.equal(resultBufferTwo[7], retailerID,'Invalid retailerID');
        assert.equal(resultBufferTwo[8], consumerID,'Invalid consumerID');
    })
